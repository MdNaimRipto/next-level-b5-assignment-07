const RotatingTextButton = ({
  ...
  return (
    <button
      className="group border-2 border-black rounded-xl px-5 py-2 cursor-pointer bg-white/80 backdrop:blur-2xl text-black hover:bg-black hover:text-white duration-300 overflow-hidden [perspective:1000px]"
      style={style}
    >
